...
for i in range(len(providers)): #in python, you go until range -1
       pooviders = providers [i]
       ipss = ips [i]
       DNS_dictionary[pooviders] = ipss
